        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="tagline" class="form-control" placeholder="e.g. ১০০% প্রাকৃতিক ভেষজ নির্যাস...">
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="badge" class="form-control" value="ফ্রি হোম ডেলিভারি">
                </div>
